...
Cloud Exercise 01 - VM Creation and Ping Test on GCP This repository contains the solution for the CLOUD-EX-01 assignment from i2i Academy.
...
- Created a free-tier account on GCP
- Enabled Compute Engine API
- Deployed a VM instance with minimal configuration
- Retrieved the external IP address
- Ran ping command from local machine to that IP
...
Created as part of the i2i Systems Internship Program / 2025